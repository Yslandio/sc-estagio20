...
<body>
    <div class="container">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="d-flex justify-content-center text-center">
                    <h4 class="title mb-0 bg-light p-2 rounded shadow-sm">Manual do SC-Estágio</h4>
                </div>
                <hr class="w-100">
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                <p>SC-Estágio (Sistema de Cálculo de Estágio), é um sistema de cálculo de horas de estágio para definir a data final de estágio.</p>
                <p class="text-danger">Depois eu faço o restante <strong>:)</strong></p>
            </div>
        </div>
    </div>
